...
struct UNavigationSystemV1 : UNavigationSystemBase {
	...
	void UnregisterNavigationInvoker(struct AActor* Invoker); // Function NavigationSystem.NavigationSystemV1.UnregisterNavigationInvoker // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void SimpleMoveToLocation(struct AController* Controller, struct FVector Goal); // Function NavigationSystem.NavigationSystemV1.SimpleMoveToLocation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
	void SimpleMoveToActor(struct AController* Controller, struct AActor* Goal); // Function NavigationSystem.NavigationSystemV1.SimpleMoveToActor // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs); // Function NavigationSystem.NavigationSystemV1.SetMaxSimultaneousTileGenerationJobsCount // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void SetGeometryGatheringMode(enum class ENavDataGatheringModeConfig NewMode); // Function NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void ResetMaxSimultaneousTileGenerationJobsCount(); // Function NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void RegisterNavigationInvoker(struct AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius); // Function NavigationSystem.NavigationSystemV1.RegisterNavigationInvoker // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	struct FVector ProjectPointToNavigation(struct UObject* WorldContextObject, struct FVector Point, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass, struct FVector QueryExtent); // Function NavigationSystem.NavigationSystemV1.ProjectPointToNavigation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	void OnNavigationBoundsUpdated(struct ANavMeshBoundsVolume* NavVolume); // Function NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	bool NavigationRaycast(struct UObject* WorldContextObject, struct FVector RayStart, struct FVector RayEnd, struct FVector HitLocation, struct UNavigationQueryFilter* FilterClass, struct AController* Querier); // Function NavigationSystem.NavigationSystemV1.NavigationRaycast // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
	bool K2_ReplaceAreaInOctreeData(struct UObject* Object, struct UNavArea* OldArea, struct UNavArea* NewArea); // Function NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	bool K2_ProjectPointToNavigation(struct UObject* WorldContextObject, struct FVector Point, struct FVector ProjectedLocation, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass, struct FVector QueryExtent); // Function NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	bool K2_GetRandomReachablePointInRadius(struct UObject* WorldContextObject, struct FVector Origin, struct FVector RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	bool K2_GetRandomPointInNavigableRadius(struct UObject* WorldContextObject, struct FVector Origin, struct FVector RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	bool K2_GetRandomLocationInNavigableRadius(struct UObject* WorldContextObject, struct FVector Origin, struct FVector RandomLocation, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.K2_GetRandomLocationInNavigableRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
	bool IsNavigationBeingBuiltOrLocked(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.IsNavigationBeingBuiltOrLocked // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	bool IsNavigationBeingBuilt(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.IsNavigationBeingBuilt // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	struct FVector GetRandomReachablePointInRadius(struct UObject* WorldContextObject, struct FVector Origin, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetRandomReachablePointInRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	struct FVector GetRandomPointInNavigableRadius(struct UObject* WorldContextObject, struct FVector Origin, float Radius, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetRandomPointInNavigableRadius // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	enum class ENavigationQueryResult GetPathLength(struct UObject* WorldContextObject, struct FVector PathStart, struct FVector PathEnd, float PathLength, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetPathLength // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	enum class ENavigationQueryResult GetPathCost(struct UObject* WorldContextObject, struct FVector PathStart, struct FVector PathEnd, float PathCost, struct ANavigationData* NavData, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.GetPathCost // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	struct UNavigationSystemV1* GetNavigationSystem(struct UObject* WorldContextObject); // Function NavigationSystem.NavigationSystemV1.GetNavigationSystem // (Final|Native|Static|Public|BlueprintCallable|BlueprintPure) // @ game+0xffff8008e4a10000
	struct UNavigationPath* FindPathToLocationSynchronously(struct UObject* WorldContextObject, struct FVector PathStart, struct FVector PathEnd, struct AActor* PathfindingContext, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.FindPathToLocationSynchronously // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
	struct UNavigationPath* FindPathToActorSynchronously(struct UObject* WorldContextObject, struct FVector PathStart, struct AActor* GoalActor, float TetherDistance, struct AActor* PathfindingContext, struct UNavigationQueryFilter* FilterClass); // Function NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously // (Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
};

// Class NavigationSystem.NavigationData
// Size: 0x490 (Inherited: 0x288)
struct ANavigationData : AActor {
	char pad_288[0x8]; // 0x288(0x08)
	struct UPrimitiveComponent* RenderingComp; // 0x290(0x08)
	struct FNavDataConfig NavDataConfig; // 0x298(0x78)
...
struct ARecastNavMesh : ANavigationData {
	...
	char bDrawMarkedForbiddenPolys : 1; // 0x491(0x01)
	char bDistinctlyDrawTilesBeingBuilt : 1; // 0x492(0x01)
	char pad_492_1 : 7; // 0x492(0x01)
	char pad_493[0x1]; // 0x493(0x01)
	float DrawOffset; // 0x494(0x04)
	char bFixedTilePoolSize : 1; // 0x498(0x01)
	char pad_498_1 : 7; // 0x498(0x01)
	char pad_499[0x3]; // 0x499(0x03)
	int32_t TilePoolSize; // 0x49c(0x04)
	float TileSizeUU; // 0x4a0(0x04)
	float CellSize; // 0x4a4(0x04)
	float CellHeight; // 0x4a8(0x04)
	float AgentRadius; // 0x4ac(0x04)
	float AgentHeight; // 0x4b0(0x04)
	float AgentMaxSlope; // 0x4b4(0x04)
	float AgentMaxStepHeight; // 0x4b8(0x04)
	float MinRegionArea; // 0x4bc(0x04)
	float MergeRegionSize; // 0x4c0(0x04)
	float MaxSimplificationError; // 0x4c4(0x04)
	int32_t MaxSimultaneousTileGenerationJobsCount; // 0x4c8(0x04)
	int32_t TileNumberHardLimit; // 0x4cc(0x04)
	int32_t PolyRefTileBits; // 0x4d0(0x04)
	int32_t PolyRefNavPolyBits; // 0x4d4(0x04)
	int32_t PolyRefSaltBits; // 0x4d8(0x04)
	struct FVector NavMeshOriginOffset; // 0x4dc(0x0c)
	float DefaultDrawDistance; // 0x4e8(0x04)
	float DefaultMaxSearchNodes; // 0x4ec(0x04)
	float DefaultMaxHierarchicalSearchNodes; // 0x4f0(0x04)
	enum class ERecastPartitioning RegionPartitioning; // 0x4f4(0x01)
	enum class ERecastPartitioning LayerPartitioning; // 0x4f5(0x01)
	char pad_4F6[0x2]; // 0x4f6(0x02)
	int32_t RegionChunkSplits; // 0x4f8(0x04)
	int32_t LayerChunkSplits; // 0x4fc(0x04)
	char bSortNavigationAreasByCost : 1; // 0x500(0x01)
	char bPerformVoxelFiltering : 1; // 0x500(0x01)
	char bMarkLowHeightAreas : 1; // 0x500(0x01)
	char bUseExtraTopCellWhenMarkingAreas : 1; // 0x500(0x01)
	char bFilterLowSpanSequences : 1; // 0x500(0x01)
	char bFilterLowSpanFromTileCache : 1; // 0x500(0x01)
	char bDoFullyAsyncNavDataGathering : 1; // 0x500(0x01)
	char bUseBetterOffsetsFromCorners : 1; // 0x500(0x01)
	char bStoreEmptyTileLayers : 1; // 0x501(0x01)
	char bUseVirtualFilters : 1; // 0x501(0x01)
	char bAllowNavLinkAsPathEnd : 1; // 0x501(0x01)
	char bUseVoxelCache : 1; // 0x501(0x01)
	char pad_501_4 : 4; // 0x501(0x01)
	char pad_502[0x2]; // 0x502(0x02)
	float TileSetUpdateInterval; // 0x504(0x04)
	float HeuristicScale; // 0x508(0x04)
	float VerticalDeviationFromGroundCompensation; // 0x50c(0x04)
	char pad_510[0x30]; // 0x510(0x30)

	bool K2_ReplaceAreaInTileBounds(struct FBox Bounds, struct UNavArea* OldArea, struct UNavArea* NewArea, bool ReplaceLinks); // Function NavigationSystem.RecastNavMesh.K2_ReplaceAreaInTileBounds // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
};
...
struct UNavigationPath : UObject {
	...
	bool IsValid(); // Function NavigationSystem.NavigationPath.IsValid // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xffff8008e4a10000
	bool IsStringPulled(); // Function NavigationSystem.NavigationPath.IsStringPulled // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xffff8008e4a10000
	bool IsPartial(); // Function NavigationSystem.NavigationPath.IsPartial // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xffff8008e4a10000
	float GetPathLength(); // Function NavigationSystem.NavigationPath.GetPathLength // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xffff8008e4a10000
	float GetPathCost(); // Function NavigationSystem.NavigationPath.GetPathCost // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xffff8008e4a10000
	struct FString GetDebugString(); // Function NavigationSystem.NavigationPath.GetDebugString // (Final|Native|Public|BlueprintCallable|BlueprintPure|Const) // @ game+0xffff8008e4a10000
	void EnableRecalculationOnInvalidation(enum class ENavigationOptionFlag DoRecalculation); // Function NavigationSystem.NavigationPath.EnableRecalculationOnInvalidation // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void EnableDebugDrawing(bool bShouldDrawDebugData, struct FLinearColor PathColor); // Function NavigationSystem.NavigationPath.EnableDebugDrawing // (Final|Native|Public|HasDefaults|BlueprintCallable) // @ game+0xffff8008e4a10000
};
...
struct ANavigationTestingActor : AActor {
	...
	struct FVector QueryingExtent; // 0x2e0(0x0c)
	char pad_2EC[0x4]; // 0x2ec(0x04)
	struct ANavigationData* MyNavData; // 0x2f0(0x08)
	struct FVector ProjectedLocation; // 0x2f8(0x0c)
	char bProjectedLocationValid : 1; // 0x304(0x01)
	char bSearchStart : 1; // 0x304(0x01)
	char pad_304_2 : 6; // 0x304(0x01)
	char pad_305[0x3]; // 0x305(0x03)
	float CostLimitFactor; // 0x308(0x04)
	float MinimumCostLimit; // 0x30c(0x04)
	char bBacktracking : 1; // 0x310(0x01)
	char bUseHierarchicalPathfinding : 1; // 0x310(0x01)
	char bGatherDetailedInfo : 1; // 0x310(0x01)
	char bDrawDistanceToWall : 1; // 0x310(0x01)
	char bShowNodePool : 1; // 0x310(0x01)
	char bShowBestPath : 1; // 0x310(0x01)
	char bShowDiffWithPreviousStep : 1; // 0x310(0x01)
	char bShouldBeVisibleInGame : 1; // 0x310(0x01)
	char pad_311[0x3]; // 0x311(0x03)
	enum class ENavCostDisplay CostDisplayMode; // 0x314(0x01)
	char pad_315[0x3]; // 0x315(0x03)
	struct FVector2D TextCanvasOffset; // 0x318(0x08)
	char bPathExist : 1; // 0x320(0x01)
	char bPathIsPartial : 1; // 0x320(0x01)
	char bPathSearchOutOfNodes : 1; // 0x320(0x01)
	char pad_320_3 : 5; // 0x320(0x01)
	char pad_321[0x3]; // 0x321(0x03)
	float PathfindingTime; // 0x324(0x04)
	float PathCost; // 0x328(0x04)
	int32_t PathfindingSteps; // 0x32c(0x04)
	struct ANavigationTestingActor* OtherActor; // 0x330(0x08)
	struct UNavigationQueryFilter* FilterClass; // 0x338(0x08)
	int32_t ShowStepIndex; // 0x340(0x04)
	float OffsetFromCornersDistance; // 0x344(0x04)
...
struct UNavLinkComponent : UPrimitiveComponent {
	struct TArray<struct FNavigationLink> Links; // 0x450(0x10)
};
...
struct UNavRelevantComponent : UActorComponent {
	...
	void SetNavigationRelevancy(bool bRelevant); // Function NavigationSystem.NavRelevantComponent.SetNavigationRelevancy // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
};
...
struct UNavModifierComponent : UNavRelevantComponent {
	...
	void SetAreaClass(struct UNavArea* NewAreaClass); // Function NavigationSystem.NavModifierComponent.SetAreaClass // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
};
...
struct ANavModifierVolume : AVolume {
	...
	void SetAreaClass(struct UNavArea* NewAreaClass); // Function NavigationSystem.NavModifierVolume.SetAreaClass // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
};
