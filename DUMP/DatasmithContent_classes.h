...
struct ADatasmithAreaLightActor : AActor {
	enum class EDatasmithAreaLightActorType LightType; // 0x288(0x01)
	enum class EDatasmithAreaLightActorShape LightShape; // 0x289(0x01)
	char pad_28A[0x2]; // 0x28a(0x02)
	struct FVector2D Dimensions; // 0x28c(0x08)
	float Intensity; // 0x294(0x04)
	enum class ELightUnits IntensityUnits; // 0x298(0x01)
	char pad_299[0x3]; // 0x299(0x03)
	struct FLinearColor Color; // 0x29c(0x10)
	float Temperature; // 0x2ac(0x04)
	struct UTextureLightProfile* IESTexture; // 0x2b0(0x08)
	bool bUseIESBrightness; // 0x2b8(0x01)
	char pad_2B9[0x3]; // 0x2b9(0x03)
	float IESBrightnessScale; // 0x2bc(0x04)
	struct FRotator Rotation; // 0x2c0(0x0c)
	float SourceRadius; // 0x2cc(0x04)
	float SourceLength; // 0x2d0(0x04)
	float AttenuationRadius; // 0x2d4(0x04)
	float SpotlightInnerAngle; // 0x2d8(0x04)
	float SpotlightOuterAngle; // 0x2dc(0x04)
};
...
struct UDatasmithContentBlueprintLibrary : UBlueprintFunctionLibrary {
	...
	struct FString GetDatasmithUserDataValueForKey(struct UObject* Object, struct FName Key); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataValueForKey // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
	void GetDatasmithUserDataKeysAndValuesForValue(struct UObject* Object, struct FString StringToMatch, struct TArray<struct FName> OutKeys, struct TArray<struct FString> OutValues); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserDataKeysAndValuesForValue // (Final|Native|Static|Public|HasOutParms|BlueprintCallable) // @ game+0xffff8008e4a10000
	struct UDatasmithAssetUserData* GetDatasmithUserData(struct UObject* Object); // Function DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData // (Final|Native|Static|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
};
...
struct ADatasmithImportedSequencesActor : AActor {
	struct TArray<struct ULevelSequence*> ImportedSequences; // 0x288(0x10)

	void PlayLevelSequence(struct ULevelSequence* SequenceToPlay); // Function DatasmithContent.DatasmithImportedSequencesActor.PlayLevelSequence // (Final|Native|Public|BlueprintCallable) // @ game+0xffff8008e4a10000
};
...
struct ADatasmithSceneActor : AActor {
	struct UDatasmithScene* Scene; // 0x288(0x08)
	struct TMap<struct FName, struct TSoftObjectPtr<struct AActor>> RelatedActors; // 0x290(0x50)
};
