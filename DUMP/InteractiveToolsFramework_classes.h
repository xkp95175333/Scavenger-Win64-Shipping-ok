...
struct UGizmoBaseComponent : UPrimitiveComponent {
	struct FLinearColor Color; // 0x448(0x10)
	float HoverSizeMultiplier; // 0x458(0x04)
	float PixelHitDistanceThreshold; // 0x45c(0x04)
	char pad_468[0x8]; // 0x468(0x08)

	void UpdateWorldLocalState(bool bWorldIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateWorldLocalState // (Final|Native|Public) // @ game+0xffff8008e4a10000
	void UpdateHoverState(bool bHoveringIn); // Function InteractiveToolsFramework.GizmoBaseComponent.UpdateHoverState // (Final|Native|Public) // @ game+0xffff8008e4a10000
};

// Class InteractiveToolsFramework.GizmoArrowComponent
// Size: 0x490 (Inherited: 0x470)
struct UGizmoArrowComponent : UGizmoBaseComponent {
	struct FVector Direction; // 0x468(0x0c)
	float Gap; // 0x474(0x04)
	float Length; // 0x478(0x04)
	float Thickness; // 0x47c(0x04)
...
struct UGizmoBoxComponent : UGizmoBaseComponent {
	struct FVector Origin; // 0x468(0x0c)
	char pad_47C[0x4]; // 0x47c(0x04)
	struct FQuat Rotation; // 0x480(0x10)
	struct FVector Dimensions; // 0x490(0x0c)
	float LineThickness; // 0x49c(0x04)
	bool bRemoveHiddenLines; // 0x4a0(0x01)
	bool bEnableAxisFlip; // 0x4a1(0x01)
...
struct UGizmoCircleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x468(0x0c)
	float Radius; // 0x474(0x04)
	float Thickness; // 0x478(0x04)
	int32_t NumSides; // 0x47c(0x04)
	bool bViewAligned; // 0x480(0x01)
	bool bOnlyAllowFrontFacingHits; // 0x481(0x01)
...
struct UGizmoTransformSource : UInterface {
	...
	void SetTransform(struct FTransform NewTransform); // Function InteractiveToolsFramework.GizmoTransformSource.SetTransform // (Native|Public|HasOutParms|HasDefaults) // @ game+0xffff8008e4a10000
	struct FTransform GetTransform(); // Function InteractiveToolsFramework.GizmoTransformSource.GetTransform // (Native|Public|HasDefaults|Const) // @ game+0xffff8008e4a10000
};
...
struct UGizmoAxisSource : UInterface {
	...
	bool HasTangentVectors(); // Function InteractiveToolsFramework.GizmoAxisSource.HasTangentVectors // (Native|Public|Const) // @ game+0xffff8008e4a10000
	void GetTangentVectors(struct FVector TangentXOut, struct FVector TangentYOut); // Function InteractiveToolsFramework.GizmoAxisSource.GetTangentVectors // (Native|Public|HasOutParms|HasDefaults|Const) // @ game+0xffff8008e4a10000
	struct FVector GetOrigin(); // Function InteractiveToolsFramework.GizmoAxisSource.GetOrigin // (Native|Public|HasDefaults|Const) // @ game+0xffff8008e4a10000
	struct FVector GetDirection(); // Function InteractiveToolsFramework.GizmoAxisSource.GetDirection // (Native|Public|HasDefaults|Const) // @ game+0xffff8008e4a10000
};
...
struct UGizmoClickTarget : UInterface {
	...
	void UpdateHoverState(bool bHovering); // Function InteractiveToolsFramework.GizmoClickTarget.UpdateHoverState // (Native|Public|Const) // @ game+0xffff8008e4a10000
};
...
struct UGizmoStateTarget : UInterface {
	...
	void EndUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.EndUpdate // (Native|Public) // @ game+0xffff8008e4a10000
	void BeginUpdate(); // Function InteractiveToolsFramework.GizmoStateTarget.BeginUpdate // (Native|Public) // @ game+0xffff8008e4a10000
};
...
struct UGizmoFloatParameterSource : UInterface {
	...
	void SetParameter(float NewValue); // Function InteractiveToolsFramework.GizmoFloatParameterSource.SetParameter // (Native|Public) // @ game+0xffff8008e4a10000
	float GetParameter(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.GetParameter // (Native|Public|Const) // @ game+0xffff8008e4a10000
	void EndModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.EndModify // (Native|Public) // @ game+0xffff8008e4a10000
	void BeginModify(); // Function InteractiveToolsFramework.GizmoFloatParameterSource.BeginModify // (Native|Public) // @ game+0xffff8008e4a10000
};
...
struct UGizmoVec2ParameterSource : UInterface {
	...
	void SetParameter(struct FVector2D NewValue); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.SetParameter // (Native|Public|HasOutParms|HasDefaults) // @ game+0xffff8008e4a10000
	struct FVector2D GetParameter(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.GetParameter // (Native|Public|HasDefaults|Const) // @ game+0xffff8008e4a10000
	void EndModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.EndModify // (Native|Public) // @ game+0xffff8008e4a10000
	void BeginModify(); // Function InteractiveToolsFramework.GizmoVec2ParameterSource.BeginModify // (Native|Public) // @ game+0xffff8008e4a10000
};
...
struct UGizmoLineHandleComponent : UGizmoBaseComponent {
	struct FVector Normal; // 0x468(0x0c)
	float HandleSize; // 0x474(0x04)
	float Thickness; // 0x478(0x04)
	struct FVector Direction; // 0x47c(0x0c)
	float Length; // 0x488(0x04)
	bool bImageScale; // 0x48c(0x01)
};

// Class InteractiveToolsFramework.GizmoRectangleComponent
// Size: 0x4a0 (Inherited: 0x470)
struct UGizmoRectangleComponent : UGizmoBaseComponent {
	struct FVector DirectionX; // 0x468(0x0c)
	struct FVector DirectionY; // 0x474(0x0c)
	float OffsetX; // 0x480(0x04)
	float OffsetY; // 0x484(0x04)
	float LengthX; // 0x488(0x04)
	float LengthY; // 0x48c(0x04)
	float Thickness; // 0x490(0x04)
	char SegmentFlags; // 0x494(0x01)
...
struct AIntervalGizmoActor : AGizmoActor {
	struct UGizmoLineHandleComponent* UpIntervalComponent; // 0x288(0x08)
	struct UGizmoLineHandleComponent* DownIntervalComponent; // 0x290(0x08)
	struct UGizmoLineHandleComponent* ForwardIntervalComponent; // 0x298(0x08)
};
...
struct ATransformGizmoActor : AGizmoActor {
	struct UPrimitiveComponent* TranslateX; // 0x288(0x08)
	struct UPrimitiveComponent* TranslateY; // 0x290(0x08)
	struct UPrimitiveComponent* TranslateZ; // 0x298(0x08)
	struct UPrimitiveComponent* TranslateYZ; // 0x2a0(0x08)
	struct UPrimitiveComponent* TranslateXZ; // 0x2a8(0x08)
	struct UPrimitiveComponent* TranslateXY; // 0x2b0(0x08)
	struct UPrimitiveComponent* RotateX; // 0x2b8(0x08)
	struct UPrimitiveComponent* RotateY; // 0x2c0(0x08)
	struct UPrimitiveComponent* RotateZ; // 0x2c8(0x08)
	struct UPrimitiveComponent* UniformScale; // 0x2d0(0x08)
	struct UPrimitiveComponent* AxisScaleX; // 0x2d8(0x08)
	struct UPrimitiveComponent* AxisScaleY; // 0x2e0(0x08)
	struct UPrimitiveComponent* AxisScaleZ; // 0x2e8(0x08)
	struct UPrimitiveComponent* PlaneScaleYZ; // 0x2f0(0x08)
	struct UPrimitiveComponent* PlaneScaleXZ; // 0x2f8(0x08)
	struct UPrimitiveComponent* PlaneScaleXY; // 0x300(0x08)
};
