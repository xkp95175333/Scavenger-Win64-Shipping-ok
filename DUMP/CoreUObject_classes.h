...
struct UObject {
	...
	void ExecuteUbergraph(int32_t EntryPoint); // Function CoreUObject.Object.ExecuteUbergraph // (Event|Public|BlueprintEvent) // @ game+0xffff8008e4a10000
};
...
// Size: 0x3f0 (Inherited: 0x238)
struct ULinkerPlaceholderClass : UClass {
	char pad_238[0x1b8]; // 0x238(0x1b8)
};
