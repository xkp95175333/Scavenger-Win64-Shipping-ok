...
enum class EAkDiffractionFlags : uint8 {
	UseBuiltInParam,
	UseObstruction,
	CalcEmitterVirtualPosition,
	EAkDiffractionFlags_MAX,
};
...
struct FAkAdvancedInitializationSettings {
	...
	uint32_t MonitorPoolSize; // 0x1c(0x04)
	uint32_t MonitorQueuePoolSize; // 0x20(0x04)
	uint32_t MaximumHardwareTimeoutMs; // 0x24(0x04)
	bool DebugOutOfRangeCheckEnabled; // 0x28(0x01)
	char pad_29[0x3]; // 0x29(0x03)
	float DebugOutOfRangeLimit; // 0x2c(0x04)
	struct FAkAdvancedSpatialAudioSettings SpatialAudioSettings; // 0x30(0x08)
};
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : FAkAdvancedInitializationSettings {
	bool EnableMultiCoreRendering; // 0x38(0x01)
...
struct FAkHololensAdvancedInitializationSettings : FAkAdvancedInitializationSettingsWithMultiCoreRendering {
	...
	bool GlobalFocus; // 0x40(0x01)
	bool UseHeadMountedDisplayAudioDevice; // 0x41(0x01)
...
// ScriptStruct AkAudio.ObsOccCache
// Size: 0x18 (Inherited: 0x00)
struct FObsOccCache {
	struct FVector m_Location; // 0x00(0x0c)
	float m_ObsValue; // 0x0c(0x04)
	float m_OccValue; // 0x10(0x04)
	float m_ExpireTime; // 0x14(0x04)
};
