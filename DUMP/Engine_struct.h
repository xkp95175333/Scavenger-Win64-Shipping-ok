...
// Enum Engine.EMaterialRenderTargetSlot
enum class EMaterialRenderTargetSlot : uint8 {
	MATRT_None,
	MATRT_SkyMask,
	MATRT_SkyBasePass,
	MATRT_Custom1,
...
enum class ESceneTextureId : uint8 {
	...
	PPI_WorldTangent,
	PPI_Anisotropy,
	PPI_MaterialRenderTarget0,
	PPI_MaterialRenderTarget1,
	PPI_MaterialRenderTarget2,
	PPI_MaterialRenderTarget3,
	PPI_MAX,
};
...
// Enum Engine.ES_CullDistanceGroup
enum class ES_CullDistanceGroup : uint8 {
	UNTAGGED,
	Decoration,
	SmallProp,
	LargeProp,
...
// ScriptStruct Engine.ActiveAnimNotifyEvent
// Size: 0xc0 (Inherited: 0x00)
struct FActiveAnimNotifyEvent {
	struct FAnimNotifyEvent Event; // 0x00(0xb8)
...
struct FAnimNotifyQueue {
	char pad_0[0x10]; // 0x00(0x10)
	struct TArray<struct FQueuedAnimNotifyEvent> AnimNotifies; // 0x10(0x10)
	struct TMap<struct FName, struct FQueuedAnimNotifyArray> UnfilteredMontageAnimNotifies; // 0x20(0x50)
};

// ScriptStruct Engine.QueuedAnimNotifyArray
// Size: 0x10 (Inherited: 0x00)
struct FQueuedAnimNotifyArray {
	struct TArray<struct FQueuedAnimNotifyEvent> Notifies; // 0x00(0x10)
};

// ScriptStruct Engine.QueuedAnimNotifyEvent
// Size: 0x18 (Inherited: 0x00)
struct FQueuedAnimNotifyEvent {
	struct FAnimNotifyEventReference Event; // 0x00(0x10)
	char pad_10[0x8]; // 0x10(0x08)
};
...
struct FTextureLODGroup {
	...
	enum class ETextureLossyCompressionAmount LossyCompressionAmount; // 0x64(0x01)
